...
public interface DemandeRepository extends JpaRepository<Demande, Long> {
    ...
    @Query("SELECT d FROM Demande d WHERE d.personne.id = :personneId ORDER BY d.dateDemande DESC")
    List<Demande> findByPersonneId(@Param("personneId") Long personneId);
